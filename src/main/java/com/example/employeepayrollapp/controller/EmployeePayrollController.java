...
public class EmployeePayrollController {
    ...
    public ResponseEntity<ResponseDTO> getEmployeePayrollData(){
        EmployeePayrolData employeePayrolData=new EmployeePayrolData(1,new EmployeePayrolDTO("Akshata","Hasabi",
    ...
    public ResponseEntity<ResponseDTO> getEmployeePayrollData(@PathVariable int id){
        EmployeePayrolData employeePayrolData=null;
               employeePayrolData =new EmployeePayrolData(2,new EmployeePayrolDTO("Akshata","Hasabi",
                                                                     "fundtech","developer",35000));
